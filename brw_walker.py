...
#Start calculations
logger_notice.info("Start walkerkarten" )
...
#path to LV03-Data
path_old_location = "/home/barpastu/Geodaten/LV03/walkerkarte"

#path to LV95-Data (without colorisation and resolution)
path_new_location="/home/barpastu/Geodaten/LV95/walkerkarte"
...
original_filename = "walker_1832.tif"
...
if not os.path.exists(path_lv03 + "/working/"):
    ...
    cmd += original_filename + " " + path_lv03 + "/working/" + original_filename
    os.system(cmd)
...
for i in os.listdir(path_lv03 + "/working/"):
    cmd = "gdaladdo -clean " + path_lv03+ "/working/" +original_filename 
    os.system(cmd)
...
#Create Tileindex
cmd = "gdaltindex -write_absolute_path " + path_lv03 + "/walker.shp " 
cmd += path_lv03 + "/working/" + original_filename 
os.system(cmd)



#Shape-File with tile division
shp = ogr.Open(path_lv03 + "/walker.shp")
...
for feature in layer:
    ...
    cmd += "-co PREDICTOR=2" 
    cmd += " -r " + method + " "  + path_lv03 + "/" + original_filename + " " + path_lv95 + "/" + outfileName_jpeg
    os.system(cmd)
...
for feature in layer:
    ...
    cmd += path_lv95 + "/ohne_overviews/" + outfileName_jpeg + " "     
    ...
    cmd += "--config PHOTOMETRIC_OVERVIEW MINISBLACK "
