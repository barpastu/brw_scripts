...
#path to LV03-Data
path_old_location = "/home/barpastu/Geodaten/LV03/ueplan_historisch"
...
if not os.path.exists(path_lv03 + "/working/"):
    ...
    for i in os.listdir(path_old_location + "/"):
        if i.endswith(".tif"):
            cmd = "gdal_translate -of GTiff -co 'TILED=YES' -a_srs EPSG:21781 -expand rgb " +path_old_location + "/"
...
for feature in layer:
    ...
    cmd += "-co PREDICTOR=2" 
    cmd += " -r " + method + " " + infileName + " " + path_lv95 + "/" + outfileName_jpeg
    os.system(cmd)
