...
handler_error = logging.FileHandler('log_brw_error_2006.log')
...
handler_notice = logging.FileHandler('log_brw_2006.log')
...
cmd = "gdalbuildvrt -vrtnodata \"255 255 255\" " + path_lv03 + "/" + orthofilename + ".vrt " + path_lv03 + "/working/*.tif"
os.system(cmd)
